...
window.BSA.tabs['tab-ndt'] = {
    ...
    features: [
        ...
        '부재 실측 · 콘크리트 강도 · 탄산화',
        '강도 측정지 사진은 Firebase Storage, Firestore는 URL/메타만 (기존 dataUrl은 동기화 시 이관)',
        ...
        '한글(HWPX): 작성한 위치도 삽입, 미작성 항목 제외, 위치도 캡션 7.1.8부터',
        '캣워크 등 추가 도면 층도 결과표·위치도에 포함 (floorsList만 보지 않음)',
        '지상5층 등 ndtData 잔여 층·부재실측 위치도(비동기 도면)·결과표 페이지 나눔',

...
window.BSA.tabs['tab-survey'] = {
    ...
    features: [
        ...
        '결함 사진 본문은 Firebase Storage, Firestore는 URL/메타만 (기존 dataUrl은 동기화 시 이관)',
        '표 컬럼 설정 (정밀/제3종)',
        ...
        '한글 내보내기: 규모 -nEA 갯수는 측정값 다음 줄',
        '한글 내보내기: 긴 조사내용은 자간 축소 없이 칸 너비에서 음절 줄바꿈',
        '엑셀 저장: 셀 자동 줄바꿈(wrap_text), 맞춤 축소 없음',

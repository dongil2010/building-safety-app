...
window.BSA.tabs['tab-home'] = {
    ...
    features: [
        ...
        '현장 목록에서 점검 종류·상/하반기 저장 후 건물을 다시 눌러도 정밀/하반기 기본값으로 되돌아가지 않음',
        '층별 도면 추가/교체: 직접 고친 층 이름·순서는 점검층 목록에서도 그대로 유지',
        '층별 도면 추가/교체: 기존 도면 위에 추가로 넣은 파일은 1F로 몰리지 않고 새 층으로 저장',

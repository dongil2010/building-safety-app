...
git add app.js index.html styles.css js/ sw.js manifest.json web-version.json scripts/ CLAUDE.md CURSOR_CHANNEL.md .cursor/rules/antigravity-bridge.mdc firestore.rules storage.rules cloudflare-worker

...
//
// ※ 이 파일은 Cloudflare 대시보드 Quick edit(파일 1개만 지원)용으로,
//   원래 ocr-proxy.js + storage-url-allowlist.js를 한 파일로 합친 버전입니다.
//   저장소의 정본은 두 파일로 분리돼 있으니, 다음에 또 고칠 땐 그쪽을 기준으로 다시 합쳐서 쓰세요.
